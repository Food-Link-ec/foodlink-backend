...
public class BeneficiarioController {
    ...
    public BeneficiarioController(RegistrarBeneficiarioUseCase registrarBeneficiarioUseCase) {
    ...
    public ResponseEntity<BeneficiarioResponse> registrar(@Valid @RequestBody RegistrarBeneficiarioRequest request) {
        BeneficiarioResponse response = registrarBeneficiarioUseCase.registrar(request);
